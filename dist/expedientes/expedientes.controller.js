...
const create_expediente_dto_1 = require("./dto/create-expediente.dto");
const create_expediente_registro_dto_1 = require("./dto/create-expediente-registro.dto");
const update_expediente_registro_dto_1 = require("./dto/update-expediente-registro.dto");
...
let ExpedientesController = class ExpedientesController {
    ...
    async addRegistro(id, dto, files = []) {
        const evidencias = await Promise.all((files ?? []).map(f => this.cloudinary.uploadBuffer(f.buffer, 'expedientes')));
        return this.svc.addRegistro(id.toString(), dto, evidencias);
    }
    async updateRegistro(expId, regId, dto, files = []) {
        const newEvidencias = await Promise.all((files ?? []).map(f => this.cloudinary.uploadBuffer(f.buffer, 'expedientes')));
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ExpedientesController.prototype, "getReporte", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ExpedientesController.prototype, "findByStudent", null);
__decorate([
    (0, common_1.Get)(':id'),
...
__decorate([
    ...
    __metadata("design:paramtypes", [mongoose_1.Types.ObjectId]),
    __metadata("design:returntype", void 0)
], ExpedientesController.prototype, "getOrCreate", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [mongoose_1.Types.ObjectId]),
    __metadata("design:returntype", void 0)
], ExpedientesController.prototype, "getRegistros", null);
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [mongoose_1.Types.ObjectId, create_expediente_registro_dto_1.CreateExpedienteRegistroDto, Array]),
    __metadata("design:returntype", Promise)
], ExpedientesController.prototype, "addRegistro", null);
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [mongoose_1.Types.ObjectId, mongoose_1.Types.ObjectId, update_expediente_registro_dto_1.UpdateExpedienteRegistroDto, Array]),
    __metadata("design:returntype", Promise)
], ExpedientesController.prototype, "updateRegistro", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ExpedientesController.prototype, "deleteRegistro", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ExpedientesController.prototype, "deleteEvidencia", null);
