    ...
    async create(dto) {
        try {
            ...
            this.notificationsService
                .createForStudentId(dto.studentId, 'expediente', 'Expediente disciplinario abierto', 'Se ha abierto un expediente disciplinario asociado a tu perfil.', '/student/mi-expediente')
                .catch(() => { });
            return saved;
        }
        catch (err) {
            if (err.code === 11000)
                throw new common_1.ConflictException('Este estudiante ya tiene un expediente');
            throw err;
        }
    }
...
exports.ExpedientesService = ExpedientesService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(expediente_schema_1.Expediente.name)),
    __param(1, (0, mongoose_1.InjectModel)(expediente_registro_schema_1.ExpedienteRegistro.name)),
